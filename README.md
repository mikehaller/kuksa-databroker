...
In addition to the gRPC interfaces, Kuksa Databroker currently provides a prototype
implementation of a subset of the [COVESA VISS v2 protocol](https://github.com/COVESA/vehicle-information-service-specification)
over WebSocket.

Current production scope is VISS v2 over WebSocket only. HTTP, MQTT, and VISS v3-related
compliance scenarios in integration tests are in-progress and not all are backed by
equivalent production server functionality yet.
