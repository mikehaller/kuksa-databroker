...
In addition to the gRPC interfaces, Kuksa Databroker also supports a subset of the
[COVESA VISS v2 protocol](https://github.com/COVESA/vehicle-information-service-specification)
over WebSocket.
