...
In addition to the gRPC interfaces, Kuksa Databroker currently provides a prototype implementation of a subset of the [COVESA VISS v2 Protocol](https://github.com/COVESA/vehicle-information-service-specification) over WebSocket.
